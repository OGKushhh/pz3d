# PostBakeCleanup — reads baked_city.res, finds overlapping buildings,
...
const INPUT_PATH := "res://scenes/baked_city.res"
const OUTPUT_PATH := "res://scenes/baked_city_clean.res"
